...
CATEGORY_CONFIG = {
    ...
    'real-estate': {
        ...
        'role': 'real estate professional', 'role_title': 'Developer',
        'page_title_suffix': '{city} Real Estate Development & Property Services',
        'meta_desc': '{name} — Trusted {city} real estate developer and property services. New builds, acquisitions, multi-family, custom homes.',
        'hero_eyebrow': 'Now Selling · Now Building',
        'hero_h1_pre': '{city} ', 'hero_h1_hl': 'Real Estate', 'hero_h1_post': ' & Development.',
        'hero_sub': 'Trusted local developer. Decades of experience. From single-family custom builds to multi-family and mixed-use developments, {name} shapes {region} one project at a time.',
        'nav_cta_noquote': 'Get In Touch', 'hero_cta_secondary': 'View Current Projects',
        'trust3_num': 'Local', 'trust3_label': '{city} Expertise',
        'trust4_num': 'Trusted', 'trust4_label': 'Builder & Partner',
        'services_eyebrow': 'What We Do',
        'services_title': 'Full-Service Real Estate Development',
        'services_sub': "From land acquisition to ribbon-cutting, our team manages every phase of the project lifecycle.",
        'services': [
            ('home', 'Custom Home Builds', 'Single-family homes designed and built around your vision, in premium {city} neighbourhoods.'),
            ('building', 'Multi-Family Projects', 'Duplexes, townhomes, apartments, condos. From concept to occupancy.'),
            ('cube', 'Mixed-Use Development', 'Ground-floor retail, residential above. Premium urban infill projects.'),
            ('chart', 'Land Acquisition & Strategy', 'Site identification, due diligence, zoning analysis, feasibility studies.'),
            ('layers', 'Project Management', 'Permits, trades, inspections, finance, sales. Single point of accountability.'),
            ('sparkles', 'Property Investment', 'Strategic acquisitions, repositioning, and asset management for accredited investors.'),
        ],
        'badge_label': '{city} Developer',
        'why_title': 'Local roots. Premium projects.',
        'why_sub': "We've spent decades building in {region}. We know the bylaws, the trades, the neighbourhoods. Projects get done on time, on budget, and to a standard we'd be proud to live in.",
        'why_points': [
            ('Long-Standing {city} Roots', 'Decades developing locally. Relationships with city hall, trades, and neighbours.'),
            ('Premium Material & Trades', 'We work with the best architects, designers, and trades in BC. No shortcuts.'),
            ('Transparent Investment Returns', 'Detailed financial modeling, regular investor updates, honest reporting.'),
            ('Hands-On Project Leadership', 'Principals on every site. No hiding behind project managers we never see.'),
        ],
        'reviews_title': 'Trusted by {city} families & investors.',
        'testimonials': [
            ('RH', 'Robert H.', '"Built our custom home from a raw lot. Every promise kept, every detail considered. We\'re still in love with the place 5 years later."'),
            ('AC', 'Alicia C.', '"Invested in their 12-unit townhouse project. Monthly updates, transparent budget tracking, and the returns exceeded the pro forma. Real pros."'),
            ('MN', 'Mark N.', '"Worked with them on a 60-unit mixed-use project. Local knowledge, deep trade relationships, and they actually listen. Easy to recommend."'),
        ],
        'area_sub': 'Active development and acquisitions throughout the region.',
        'contact_title': "Let's talk about a project.",
        'form_title': 'Get in touch',
        'form_sub': "Tell us a bit about what you're considering. We'll get back within 1 business day.",
        'form_type_label': 'I am interested in',
        'form_options': ['Building a Custom Home', 'A Current Project', 'Investing as a Partner', 'Selling Land or a Building', 'Other / Just Exploring'],
        'form_message_label': 'Tell us more',
        'form_message_placeholder': 'Site address, timeline, budget, investment size, anything relevant...',
        'form_submit': 'Send My Inquiry →',
        'final_cta_title': "Building something? Let's chat.",
        'final_cta_sub': 'Local expertise. Premium execution. Real partnerships.',
        'final_cta_btn_phone': 'Call {phone} Today',
        'final_cta_btn_form': 'Get In Touch →',
        'footer_para': 'Local real estate developer based in {city}, BC. Custom homes, multi-family, and mixed-use projects throughout {region}.',
        'footer_services': ['Custom Homes', 'Multi-Family', 'Mixed-Use', 'Investment', 'Project Management'],
        'footer_cert': 'Licensed · Bonded · BC Owned',
        'contact_label_phone': 'Call Office',
        'hours': ('Mon–Fri: 9am – 5pm', 'Weekends by appointment'),
        'area_title_verb': 'developing across',
    },
    'local-business': {
        'assets': 'local-business',
        'industry': 'Local Services',
        'role': 'business owner', 'role_title': 'Owner',
        'page_title_suffix': '{city} Local Business & Services',
        'meta_desc': '{name} — Trusted local {city} business. Professional service, reliable team, honest pricing.',
        'hero_eyebrow': 'Open Now · Locally Owned',
        'hero_h1_pre': '{city} ', 'hero_h1_hl': 'Local', 'hero_h1_post': ' Service You Can Trust.',
        'hero_sub': "Locally owned. Genuinely cared about. {name} has been serving {region} with reliable service and honest pricing — the kind of business neighbours recommend to neighbours.",
        'nav_cta_noquote': 'Get In Touch', 'hero_cta_secondary': 'Get In Touch',
        'trust3_num': 'Local', 'trust3_label': '{city}-Owned',
        'trust4_num': 'Trusted', 'trust4_label': 'By Neighbours',
        'services_eyebrow': 'What We Do',
        'services_title': 'Service That Feels Local',
        'services_sub': "We're here for our community, not for shareholders. Real people, real conversations, real service.",
        'services': [
            ('sparkles', 'Personalized Service', 'You\'re not a ticket number. Real conversations, real solutions, real follow-through.'),
            ('clock', 'Reliable Scheduling', 'When we say we\'ll be there, we\'re there. No mystery cancellations, no ghosting.'),
            ('shield', 'Honest, Upfront Pricing', 'No surprise add-ons. You know what it costs before we start.'),
            ('chart', 'Years of Experience', 'Trade-savvy, customer-savvy, and locally invested. We\'ve seen it all.'),
            ('home', 'Local Community First', 'We hire locally, source locally, and reinvest in the neighbourhoods we serve.'),
            ('search', 'Quality You Can See', 'Every job done right the first time — because reputation is everything.'),
        ],
        'badge_label': '{city} Local',
        'why_title': 'Local matters.',
        'why_sub': "Big chains don't return your calls. Faceless brands don't remember your name. We do. Because this is our community too.",
        'why_points': [
            ('Locally Owned & Operated', 'No corporate HQ in another province. Decisions made here, by people who live here.'),
            ('Word-of-Mouth Driven', 'Most of our business comes from referrals. We work hard to keep it that way.'),
            ('Long-Term Reputation', "We're not chasing the next quarter. We're building a name that lasts decades."),
            ('Real Accountability', 'Something not right? You get a real person, fast. We make it right.'),
        ],
        'reviews_title': 'Trusted by {city} neighbours.',
        'testimonials': [
            ('JP', 'Janelle P.', '"Honestly, they treated me better than I\'ve been treated by any business in years. Real people who actually care."'),
            ('BS', 'Brent S.', '"My go-to in {city}. Honest, on-time, fairly priced. I send everyone I know."'),
            ('MR', 'Maria R.', '"What\'s rare these days is service that feels personal. This place delivers it every single time."'),
        ],
        'area_sub': 'Proudly serving the local community.',
        'contact_title': "Got a question? Let's chat.",
        'form_title': 'Get in touch',
        'form_sub': "Drop us a quick note. We'll respond within 1 business day.",
        'form_type_label': 'How can we help?',
        'form_options': ['General Inquiry', 'Service Question', 'Pricing / Estimate', 'Existing Customer Support', 'Other'],
        'form_message_label': 'What\'s on your mind?',
        'form_message_placeholder': 'Tell us what you need help with...',
        'form_submit': 'Send My Message →',
        'final_cta_title': "Local service. Real people. Honest work.",
        'final_cta_sub': "That's what we do. Reach out and let's chat.",
        'final_cta_btn_phone': 'Call {phone} Today',
        'final_cta_btn_form': 'Get In Touch →',
        'footer_para': 'Locally owned business serving {city} and {region}. Real people, honest service, genuine community focus.',
        'footer_services': ['Personalized Service', 'Local Expertise', 'Honest Pricing', 'Reliable Scheduling', 'Quality Workmanship'],
        'footer_cert': 'Locally Owned · BC Operated',
        'contact_label_phone': 'Call Us',
        'hours': ('Mon–Fri: 9am – 5pm', 'Weekends by appointment'),
    },
}
...
CATEGORY_ROUTING = {
    ...
    'Architecture firm': 'real-estate',
    'Architect': 'real-estate',
    'Homestay': 'real-estate',
    # Routable misfits to existing templates
    'Septic system service': 'plumbers',
    'Bathroom supply store': 'interior',
    'Home improvement store': 'contractors',
    'Industrial equipment supplier': 'contractors',
    'Paint store': 'drywall',
    'Plastic fabrication company': 'contractors',
    'Plastic injection molding service': 'contractors',
    'Swimming pool contractor': 'contractors',
    'Swimming pool repair service': 'handyman',
    'Firewood supplier': 'landscapers',
    'Waste-Management Service': 'handyman',
    'Waste management service': 'handyman',
    'Agricultural production': 'landscapers',
    'Home inspector': 'contractors',
    'Drafting service': 'contractors',
    'Civil engineering company': 'contractors',
    'Drafting equipment supplier': 'contractors',
    'Telecommunications equipment supplier': 'electricians',
    'Garage builder': 'contractors',
    'Trucking company': 'excavating',
    # Singleton specialty / business → generic local-business
    'Auto repair shop': 'local-business',
    'Mechanic': 'local-business',
    'Boat repair shop': 'local-business',
    'Appliance repair service': 'local-business',
    'Corporate office': 'local-business',
    'Wedding photographer': 'local-business',
    'Wholesaler': 'local-business',
    'Professional organizer': 'local-business',
    'Association / Organization': 'local-business',
    'Bag shop': 'local-business',
    'Watch repair service': 'local-business',
    'Consultant': 'local-business',
    'Business management consultant': 'local-business',
    'Vehicle wrapping service': 'local-business',
    'Service establishment': 'local-business',
    'Home automation company': 'electricians',
    'Modern izakaya restaurant': 'local-business',
}
